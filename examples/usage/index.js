...
var WebIFC = require("../../dist/web-ifc-api-node.js");
var ifc2x4 = require("../../src/ifc2x4_helper");
var fs = require("fs");
...
function LoadFile(filename) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ifcData = fs.readFileSync(filename);
                    return [4 /*yield*/, ifcapi.Init()];
                case 1:
                    _a.sent();
                    modelID = ifcapi.OpenModel("example.ifc", new Uint8Array(ifcData));
