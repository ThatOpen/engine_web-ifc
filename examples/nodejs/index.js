...
async function LoadFile(filename) {
    ...
    ///Edit already existing entities
    ...
    for (let i = 0; i < storeys.size(); i++) {
        ...
        storey.Description = { type: 1, value: 'Description' }; //value content always contained in ''
        storey.Name = { type: 1, value: 'Name' }; //Type value must correct otherwise fails
        storey.LongName = { type: 1, value: 'Long name' };
        ifcapi.WriteLine(modelID, storey);
    }

    //ex2.- Edit IfcProperty
