...
namespace webifc::geometry
{
  ...
  public:
    ...
    std::optional<glm::dvec4> GetColor(uint32_t expressID);
    ...
    IfcAlignment GetAlignment(uint32_t expressID, IfcAlignment alignment = IfcAlignment(), glm::dmat4 transform = glm::dmat4(1), uint32_t sourceExpressID = -1);
    ...
    std::unordered_map<uint32_t, std::vector<uint32_t>> &GetRelElementAggregates();
