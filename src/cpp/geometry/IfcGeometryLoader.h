...
namespace webifc::geometry
{
  ...
  public:
    ...
    glm::dmat4 GetLocalPlacement(const uint32_t expressID, std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement, glm::dvec3 vector = glm::dvec3(1)) const;
    ...
    IfcProfile GetProfile(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement) const;
    IfcProfile GetProfile3D(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement) const;
    IfcCurve GetLocalCurve(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement) const;
    IfcCurve GetCurve(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement,uint8_t dimensions, bool edge=false) const;
    ...
    IfcCurve GetOrientedEdge(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement) const;
    IfcCurve GetEdge(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement) const;
    IfcBound3D GetBound(const uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement) const;
    IfcCurve GetLoop(const uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement) const;
    std::optional<glm::dvec4> GetColor(uint32_t expressID) const;
    IfcCrossSections GetCrossSections2D(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement) const;
    IfcCrossSections GetCrossSections3D(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement, bool scaled = false, glm::dmat4 coordination = glm::dmat4(1)) const;
    IfcAlignment GetAlignment(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement, IfcAlignment alignment = IfcAlignment(), glm::dmat4 transform = glm::dmat4(1), uint32_t sourceExpressID = -1) const;
  ...
  private:
    IfcCurve GetAlignmentCurve(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement, uint32_t parentExpressID = -1) const;
    IfcProfile GetProfileByLine(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement) const;
    ...
    void ComputeCurve(uint32_t expressID,  std::unordered_map<uint32_t, glm::dmat4> &_expressIDToPlacement, IfcCurve &curve, uint8_t dimensions, bool edge, int sameSense = -1, int trimSense = -1, IfcTrimmingArguments trim = {}) const;
