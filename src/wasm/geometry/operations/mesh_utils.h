...
namespace webifc::geometry
{
	...
	inline static void svgMakeLine(glm::dvec2 a, glm::dvec2 b, std::stringstream &svg, std::string col = "rgb(255,0,0)")
	{
	...
	inline static void SVGLinesToString(Bounds bounds, glm::dvec2 size, glm::dvec2 offset, SVGLineSet lineSet, std::stringstream &svg)
	{
	...
	inline static std::string makeSVGLines(SVGDrawing drawing)
	{
	...
	inline static std::string VAlignmentToObj(const std::vector<IfcAlignment> &geom)
	{
	...
	inline static std::string HAlignmentToObj(const std::vector<IfcAlignment> &geom)
	{
		std::stringstream obj;
	...
	inline static std::string ToObj(const IfcGeometry &geom, size_t &offset, glm::dmat4 transform = glm::dmat4(1), double inputScale = 1.0)
	{
		std::stringstream obj;
	...
	inline std::string ToObj(IfcComposedMesh &mesh, std::unordered_map<uint32_t, IfcGeometry> &geometryMap, size_t &offset, glm::dmat4 mat = glm::dmat4(1))
	{
		std::string complete;
		...
		inline void DumpAlignment(std::vector<IfcAlignment> &align, std::wstring filenameV, std::wstring filenameH)
		{
			size_t offset = 0;
	...
	inline static void DumpIfcGeometryToPath(const IfcGeometry &geom, std::wstring path, double inputScale)
	{
		size_t offset = 0;
