...
let expectedVertexAndIndexDatas: any = {
    ...
    vertexDatas: "-1035.698974609375,-191.80441284179688,558.7999877929688,0,0,1,632.95263671875,-191.80441284179688,558.7999877929688,0,0,1,402.746337890625,383.60882568359375,558.7999877929688,0,0,1,-1035.698974609375,-191.80441284179688,558.7999877929688,0,0,1,-1035.698974609375,-191.80441284179688,0,0,0,-1,632.95263671875,-191.80441284179688,0,0,0,-1,402.746337890625,383.60882568359375,0,0,0,-1,-1035.698974609375,-191.80441284179688,0,0,0,-1,-1035.698974609375,-191.80441284179688,0,0,-1,0,632.95263671875,-191.80441284179688,558.7999877929688,0,-1,0,-1035.698974609375,-191.80441284179688,558.7999877929688,0,-1,0,-1035.698974609375,-191.80441284179688,0,0,-1,0,632.95263671875,-191.80441284179688,0,0,-1,0,632.95263671875,-191.80441284179688,558.7999877929688,0,-1,0,632.95263671875,-191.80441284179688,0,0.9284539222717285,0.3714476525783539,0,402.746337890625,383.60882568359375,558.7999877929688,0.9284539222717285,0.3714476525783539,0,632.95263671875,-191.80441284179688,558.7999877929688,0.9284539222717285,0.3714476525783539,0,632.95263671875,-191.80441284179688,0,0.9284539222717285,0.3714476525783539,0,402.746337890625,383.60882568359375,0,0.9284539222717285,0.3714476525783539,0,402.746337890625,383.60882568359375,558.7999877929688,0.9284539222717285,0.3714476525783539,0,402.746337890625,383.60882568359375,0,-0.37141022086143494,0.9284688830375671,0,-1035.698974609375,-191.80441284179688,558.7999877929688,-0.37141022086143494,0.9284688830375671,0,402.746337890625,383.60882568359375,558.7999877929688,-0.37141022086143494,0.9284688830375671,0,402.746337890625,383.60882568359375,0,-0.37141022086143494,0.9284688830375671,0,-1035.698974609375,-191.80441284179688,0,-0.37141022086143494,0.9284688830375671,0,-1035.698974609375,-191.80441284179688,558.7999877929688,-0.37141022086143494,0.9284688830375671,0"
}
...
describe('spaces and openings inclusion', () => {
    test('INCLUDE_SPACES_AND_OPENINGS also streams IfcSpace/IfcOpeningElement meshes', () => {
        // example.ifc contains one IFCSPACE (#9989) and no openings
        const ifcData = fs.readFileSync(path.join(__dirname, '../ifcfiles/public/example.ifc'));
        let inclusiveModelID = ifcApi.OpenModel(ifcData, { INCLUDE_SPACES_AND_OPENINGS: true });
        let count: number = 0;
        let spaceSeen = false;
        ifcApi.StreamAllMeshes(inclusiveModelID, (mesh) => {
            count++;
            if (ifcApi.GetLineType(inclusiveModelID, mesh.expressID) == WebIFC.IFCSPACE) spaceSeen = true;
        });
        ifcApi.CloseModel(inclusiveModelID);
        expect(count).toEqual(meshesCount + 1);
        expect(spaceSeen).toBe(true);
    })
});
