...
describe('WebIfcApi geometries', () => {
    ...
    test('expect correct vertex and index array from A flat Mesh', () => {
        let flatMesh = ifcApi.GetFlatMesh(0, geometries.get(expectedVertexAndIndexDatas.geometryIndex).expressID);
        let geometry = ifcApi.GetGeometry(0, flatMesh.geometries.get(0).geometryExpressID);
